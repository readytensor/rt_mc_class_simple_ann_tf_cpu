# Artificial Neural Network Multiclass Classifier in TensorFlow (CPU) with Shapley Explanations
## Project Description
...
- A **Artificial Neural Network (ANN)** Multiclass Classifier built using **TensorFlow**. The model runs on CPU.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Artificial Neural Network (ANN) Multiclass Classifier model implemented using TensorFlow.
